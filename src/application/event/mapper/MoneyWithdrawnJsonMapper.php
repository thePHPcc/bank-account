 ...
 * @no-named-arguments
 */
final class MoneyWithdrawnJsonMapper implements EventArrayMapper
{
    /**
     ...
     */
    public function fromArray(array $data): MoneyWithdrawnEvent
    {
    ...
    {
        assert($event instanceof MoneyWithdrawnEvent);
